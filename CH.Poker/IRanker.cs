...
{
    /// <summary>
    /// This ranking iterface was chosen based on my previous knowledge of high speed poker ranking algoritms and may seem a little weird at first.
    /// We map each card into a 0 to 51 number space to make lookups in internal arrays easier when we start to move into higher speed algorithms.
    /// We also don't report back hand order (family, e.g. Flush) or any information about the cards for breaking ties. Each hand is boiled down to
    /// a single number to make sorted hands relative to each other something that can be down easily and effiently in the calling code.
    /// </summary>
